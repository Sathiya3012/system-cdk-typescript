    ...
    def __init__(
        ...
        **kwargs,
        ...
        amplify_app_distribution = cloudfront.Distribution(
            self,
            f"rCustomCloudFrontDistribution--{branch_name}",
        ...
        cache_invalidation_function_role = iam.Role(
            self,
            f"rCacheInvalidationFunctionCustomRole--${branch_name}",
        ...
        cache_invalidation_function_custom_policy = iam.ManagedPolicy(
            self,
            f"rCacheInvalidationFunctionCustomPolicy--{branch_name}",
            statements=[
                iam.PolicyStatement(
        ...
        events.Rule(
            self,
            f"rInvokeCacheInvalidation--{branch_name}",
        ...
        CfnOutput(
            self,
            f"oCloudFrontDistributionDomain--{branch_name}",
